...
export function RootNavigator() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="Habits" component={WrappedHabitList} options={{ title: "Habitos" }} />
      <Stack.Screen name="HabitNew" component={WrappedHabitNew} options={{ title: "Novo habito" }} />
      <Stack.Screen name="HabitDetail" component={WrappedHabitDetail} options={{ title: "Detalhe do habito" }} />
      <Stack.Screen name="HabitEdit" component={WrappedHabitEdit} options={{ title: "Editar habito" }} />
      ...
      <Stack.Screen name="FocusSession" component={WrappedFocusSession} options={{ title: "Sessao de foco" }} />
      <Stack.Screen name="FocusHistory" component={WrappedFocusHistory} options={{ title: "Historico de foco" }} />
      <Stack.Screen name="FocusSummary" component={WrappedFocusSummary} options={{ title: "Resumo da sessao" }} />

      <Stack.Screen name="ProgressOverview" component={WrappedProgressOverview} options={{ title: "Progresso geral" }} />
      <Stack.Screen name="ProgressFocus" component={WrappedProgressFocus} options={{ title: "Analise de foco" }} />
      <Stack.Screen name="ProgressTasks" component={WrappedProgressTasks} options={{ title: "Analise de tarefas" }} />
      <Stack.Screen name="ProgressHabits" component={WrappedProgressHabits} options={{ title: "Analise de habitos" }} />
      ...
      <Stack.Screen name="Gamification" component={WrappedGamification} options={{ title: "Gamificacao" }} />
      ...
      <Stack.Screen name="Settings" component={WrappedSettings} options={{ title: "Configuracoes" }} />
      <Stack.Screen name="SettingsAppearance" component={WrappedSettingsAppearance} options={{ title: "Aparencia" }} />
      <Stack.Screen name="SettingsFocus" component={WrappedSettingsFocus} options={{ title: "Foco" }} />
      <Stack.Screen name="SettingsNotifications" component={WrappedSettingsNotifications} options={{ title: "Notificacoes" }} />
